...
public struct AmbientSoundState: Equatable, Sendable {
    ...
    /// XM6 firmware with automatic ambient detection uses variant 0x19.
    /// Preserve these settings when changing the listening mode.
    public var adaptiveEnabled: Bool?
    public var adaptiveSensitivity: UInt8?
    ...
    public init(
        ...
        adaptiveEnabled: Bool? = nil,
        adaptiveSensitivity: UInt8? = nil
    ) {
        self.mode = mode
